...
//amitai
void Event::setGameupdae (std::string key,std::string value){
    this->game_updates[key] = value;
}
void Event::setGameupdaeA (std::string key,std::string value){
    this->team_a_updates[key] = value;
}
void Event::setGameupdaeB (std::string key,std::string value){
    this->team_b_updates[key] = value;
}
